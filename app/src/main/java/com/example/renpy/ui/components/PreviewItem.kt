package com.example.renpy.ui.components
...
/**
 * Single row in the rename preview list: original filename, an arrow, and
 * the proposed new filename. If the names are identical (no-op), the arrow
 * and new name are de-emphasized.
 */
@Composable
